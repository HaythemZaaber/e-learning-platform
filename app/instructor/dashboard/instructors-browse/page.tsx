...
export default function InstructorInstructorsBrowsePage() {
          ...
          <div className="container py-8 px-5">
            {isLoading ? (
              ...
              <EmptyState
                ...
                description="No instructors match your current search criteria. Try adjusting your filters or search terms."
                action={
                  <Button
