...
export default function InstructorMyLearningPage() {
        ...
        <Card className="w-full max-w-md text-center">
          <CardContent className="pt-6">
            ...
            <p className="text-blue-600 mb-6">
              You need to be signed in to access your learning courses.
            </p>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Continue your learning journey as an instructor
              </p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-8">
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <Input
                placeholder="Search your learning courses..."
                value={searchTerm}
          ...
          <Card className="text-center py-12">
            <CardContent>
              ...
              <p className="text-gray-600 mb-4">
                There was an error loading your learning courses. Please try
                again.
              </p>
            ...
            <CardContent>
              ...
              <p className="text-gray-600 mb-4">
                ...
                levelFilter !== "all"
                  ...
                  : "You haven't enrolled in any learning courses yet. Start your learning journey today!"}
              </p>
              {!searchTerm &&
                statusFilter === "all" &&
                categoryFilter === "all" &&
