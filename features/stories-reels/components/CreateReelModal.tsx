...
import { REEL_MAX_DURATION } from "@/types/storiesReelsTypes";
...
export function CreateReelModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await storiesReelsService.createReel(
        {
          file,
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold">Create Reel</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-6">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Max {REEL_MAX_DURATION}s for videos • Max 200MB
                  </p>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    >
                      {isPublic ? "Public Reel" : "Private Reel"}
                    </Label>
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
            <p className="text-sm text-purple-800">
              <strong>Note:</strong> Reels are permanent content that will be
              displayed on your profile and in the reels feed for all users to
              discover.
            </p>
          </div>
        </div>
