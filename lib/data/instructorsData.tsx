...
export const instructors: Instructor[] = [
  {
    ...
    philosophy: "My teaching philosophy centers on making complex concepts accessible through practical examples and real-world applications. I believe anyone can master data science with the right guidance.",
    ...
    courses: [
      {
        ...
        description: "Master the basics of data science using Python in this comprehensive course.",
      ...
      },
      {
        ...
        description: "Take your ML skills to the next level with advanced algorithms and approaches.",
        thumbnail: "/placeholder.svg?height=300&width=500",
        category: "Data Science",
        level: "Advanced",
        price: 129.99,
    ...
    sessionPricing: {
      individual: { 30: 80, 60: 120, 120: 200 },
      group: { 30: 50, 60: 80, 120: 140 },
    },
    maxGroupSize: 8,
    bufferTime: 15,
    maxSessionsPerDay: 6,
  ...
  },
  {
    ...
    experience: 15,
    education: ["MFA in Design, Rhode Island School of Design", "B.A. in Graphic Design, Parsons School of Design"],
    certifications: [
      "Adobe Certified Expert",
      "Google UX Design Professional Certificate",
      "Interaction Design Foundation Certification",
    ],
    philosophy: "Design is problem-solving at its core. I teach students to understand the 'why' behind every design decision and to put users first in everything they create.",
    categories: ["Design"],
    skills: [
    ...
    courses: [
      {
        ...
        description: "Comprehensive course covering all aspects of modern UI/UX design from fundamentals to advanced techniques.",
        thumbnail: "/placeholder.svg?height=300&width=500",
        category: "Design",
        level: "All Levels",
        price: 109.99,
      ...
      },
      {
        ...
        description: "Learn to create sophisticated designs and prototypes in Figma for collaborative team environments.",
        thumbnail: "/placeholder.svg?height=300&width=500",
        category: "Design",
        level: "Intermediate",
        price: 79.99,
  ...
  },
  {
    ...
    experience: 8,
    education: ["B.S. in Computer Science, University of Texas", "Full Stack Web Development Bootcamp, Coding Dojo"],
    certifications: ["AWS Certified Developer", "MongoDB Certified Developer", "React Certification"],
    philosophy: "I believe in learning by doing. My courses are built around real-world projects that give students practical experience they can immediately apply to their work.",
    ...
    courses: [
      {
        ...
        description: "Master JavaScript from the basics to advanced concepts and front-end development with React.",
        thumbnail: "/placeholder.svg?height=300&width=500",
  ...
  },
  {
    ...
    languages: ["English"],
    experience: 12,
    education: ["MBA with Marketing Focus, Northwestern University", "B.A. in Communications, University of Michigan"],
    certifications: [
      "Google Analytics Certification",
      "HubSpot Content Marketing Certification",
      "Facebook Blueprint Certification",
    ],
    philosophy: "Marketing is about connecting with people authentically. I teach strategies that not only drive traffic and conversions but also build lasting relationships with customers.",
    ...
    courses: [
      {
        ...
        description: "Learn modern SEO techniques to improve your website's visibility and organic traffic.",
        thumbnail: "/placeholder.svg?height=300&width=500",
        category: "Marketing",
        level: "All Levels",
        price: 89.99,
      ...
      },
      {
        ...
        description: "Develop and implement effective content marketing strategies that drive engagement.",
        thumbnail: "/placeholder.svg?height=300&width=500",
        category: "Marketing",
        level: "Intermediate",
        price: 79.99,
  ...
  },
  {
    ...
    certifications: ["Certified Music Educator", "Dalcroze Eurhythmics Certification"],
    philosophy:
    ...
    courses: [
      {
        ...
        description: "A complete course covering all aspects of music theory from basics to advanced concepts.",
        thumbnail: "/placeholder.svg?height=300&width=500",
        category: "Music",
        level: "All Levels",
        price: 99.99,
      ...
      },
      {
        ...
        description: "Learn the art of classical music composition from fundamental principles to complete works.",
        thumbnail: "/placeholder.svg?height=300&width=500",
        category: "Music",
        level: "Advanced",
        price: 129.99,
...
//     responseTime: "Under 24 hours",
//     completionRate: 93,
//     languages: ["English", "Mandarin", "Spanish", "French", "Japanese", "Korean", "Italian"],
//     experience: 12,
//     education: [
//       "M.A. in Applied Linguistics, Georgetown University",
//       "B.A. in Modern Languages, University of California, Berkeley",
//     ],
//     certifications: ["TESOL Certification", "ACTFL OPI Tester", "Cambridge CELTA"],
//     philosophy:
...
//         description: "Start speaking Mandarin Chinese from day one with this practical, immersive approach.",
//         thumbnail: "/placeholder.svg?height=300&width=500",
//         category: "Languages",
//         level: "Beginner",
//         price: 84.99,
...
//         description: "Learn professional Spanish for international business contexts and negotiations.",
//         thumbnail: "/placeholder.svg?height=300&width=500",
//         category: "Languages",
//         level: "Intermediate",
//         price: 94.99,
...
//     shortBio: "Award-winning photographer and cinematographer with work featured in major publications.",
//     rating: 4.7,
//     reviewsCount: 932,
//     studentsCount: 19800,
//     coursesCount: 9,
...
//     languages: ["English"],
//     experience: 15,
//     education: ["M.F.A. in Photography, School of Visual Arts", "B.F.A. in Film, NYU Tisch School of the Arts"],
//     certifications: ["Adobe Certified Expert in Photoshop", "RED Digital Cinema Certified Operator"],
//     philosophy:
...
//         description: "Take your photography to the next level with professional lighting setups and techniques.",
//         thumbnail: "/placeholder.svg?height=300&width=500",
//         category: "Photography",
//         level: "Advanced",
//         price: 109.99,
...
//     id: "8",
//     name: "Sophia Kim",
//     title: "Entrepreneurship & Business Strategy Coach",
//     avatar: "/placeholder.svg?height=400&width=400",
//     bio: "Sophia is a serial entrepreneur who has successfully founded and sold three tech startups. With an MBA from Harvard and experience as a venture capital advisor, she brings real-world business expertise to her teaching. Her courses focus on practical strategies for business growth and sustainable entrepreneurship.",
//     shortBio: "Serial entrepreneur and business strategist with experience founding and selling tech startups.",
//     rating: 4.8,
//     reviewsCount: 1125,
//     studentsCount: 24600,
//     coursesCount: 5,
...
//     experience: 14,
//     education: ["MBA, Harvard Business School", "B.S. in Economics, Wharton School of Business"],
//     certifications: ["Certified Business Coach", "Lean Six Sigma Black Belt"],
//     philosophy:
//       "Business success comes from a combination of strategic thinking and bold execution. I teach entrepreneurs how to develop both aspects while staying true to their vision and values.",
//     categories: ["Business"],
//     skills: [
//       { name: "Business Strategy", proficiency: "Expert" },
//       { name: "Startup Development", proficiency: "Expert" },
//       { name: "Venture Capital", proficiency: "Advanced" },
//       { name: "Financial Planning", proficiency: "Advanced" },
//       { name: "Leadership", proficiency: "Expert" },
//     ],
//     courses: [
//       {
//         id: "c16",
//         title: "Startup Success: From Idea to Exit",
//         description: "A comprehensive guide to building a successful startup from concept to profitable exit.",
//         thumbnail: "/placeholder.svg?height=300&width=500",
//         category: "Business",
//         level: "All Levels",
//         price: 129.99,
...
//         description: "Learn proven strategies to scale your business and achieve sustainable growth.",
//         thumbnail: "/placeholder.svg?height=300&width=500",
//         category: "Business",
//         level: "Intermediate",
//         price: 99.99,
...
//         date: "2023-12-08",
//         rating: 5,
//         text: "Sophia's startup course gave me the confidence and knowledge to finally launch my business. Her insights from real-world experience are invaluable.",
//         course: "Startup Success: From Idea to Exit",
//       },
//       {
//         id: "r17",
//         name: "Rachel B.",
...
//         date: "2023-10-25",
//         rating: 5,
//         text: "The growth strategies course helped me double my company's revenue in just 8 months. The ROI on this course has been incredible!",
//         course: "Business Growth Strategies",
//       },
//     ],
//     featuredCourse: "c16",
//     location: "New York, NY",
...
//       website: "https://sophiakim.business",
//     },
//     isOnline: true,
//     isVerified: true,
//     priceRange: {
