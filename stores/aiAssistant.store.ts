...
import {
  ...
  SuggestionType,
  ContentType,
} from "../features/course-creation/services/aiAssistantService";
...
export const useAIAssistantStore = create<AIAssistantState>()((set, get) => ({
  ...
  chatHistory: [
    {
      role: "assistant",
      content:
        "Hello! I'm your AI course creation assistant. I can help you with suggestions, analyze your course, generate content, and answer any questions about course development.",
      timestamp: new Date(),
    },
  ],
  generatedContent: {},
  ...
  analyzeCourse: async (courseData, contentByLecture) => {
    ...
    try {
      const analysis = await service.analyzeCourse(
        courseData,
        contentByLecture
      );
      ...
      chatHistory: [
        {
          role: "assistant",
          content:
            "Hello! I'm your AI course creation assistant. How can I help you today?",
          timestamp: new Date(),
        },
      ],
    }),
